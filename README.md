...
I would describe it as the tool help anyone with visual problems to still understand what cannot be seen.
2. Talk about 3 different things you can do to ensure your website is accessible. 
Use responsive units as well as using the @media tag to make the whole layout responsive.
3. How would you explain the concept of a variable to someone new to programming?
I would explain a variable as a container that holds data.
4. What is the purpose of using functions in code?
Keeps code neater, no hardcoding, lets functions be reusable with other parameters.
